...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--save_result_freq', type=int, default=1000, help='frequency of saving the latest prediction results')
        parser.add_argument('--save_latest_freq', type=int, default=1000, help='frequency of saving the latest trained model')
        ...
        parser.add_argument('--lr_task', type=float, default=2e-4, help='initial learning rate for adam')
        parser.add_argument('--lr_trans', type=float, default=1e-4, help='initial learning rate for adam')
